...
(function (global, factory) {
  ...
  _exports.filterPropsFrom = filterPropsFrom;
  var internalProps = {
...
(function (global, factory) {
  ...
  _exports.stringable = stringable;
...
})(this, function (_exports, _stringable) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.extractDataFrom = extractDataFrom;
...
(function (global, factory) {
  ...
  _exports.isReactComponent = isReactComponent;
...
(function (global, factory) {
  ...
  _exports.unsafe = unsafe;
  _exports.isUnsafe = isUnsafe;
...
(function (global, factory) {
  ...
  _exports.Filterer = _exports.FiltererInput = void 0;
  ...
  _exports.FiltererInput = FiltererInput;
  ;
...
})(this, function (_exports, _react, _is_react_component, _stringable, _unsafe, _filter_props_from) {
  "use strict";
...
})(this, function (_exports, _react, _td, _to_array, _filter_props_from) {
  "use strict";
...
})(this, function (_exports, _react, _unsafe, _filter_props_from) {
  "use strict";
  ...
  function (_React$Component) {
    ...
    _createClass(Th, [{
      ...
      value: function render() {
        ...
        if ((0, _unsafe.isUnsafe)(this.props.children)) {
          return _react.default.createElement("th", _extends({}, (0, _filter_props_from.filterPropsFrom)(this.props), {
            dangerouslySetInnerHTML: {
              __html: this.props.children.toString()
            }
          }));
        } else {
          return _react.default.createElement("th", (0, _filter_props_from.filterPropsFrom)(this.props), this.props.children);
        }
      }
    }]);
...
})(this, function (_exports, _react, _th, _filterer, _filter_props_from) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.Thead = void 0;
  _react = _interopRequireDefault(_react);
...
})(this, function (_exports, _react, _filter_props_from, _extract_data_from, _unsafe, _thead, _th, _tr, _tfoot, _paginator) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.Table = void 0;
  _react = _interopRequireDefault(_react);
  ...
  function (_React$Component) {
    ...
    _createClass(Table, [{
      ...
      value: function parseChildData(props) {
        var data = [],
            tfoot; // Transform any children back to a data array
            ...
            switch ("".concat(child.type)) {
              ...
              case "".concat(_tr.Tr):
                ...
                _react.default.Children.forEach(child.props.children, function (descendant) {
                  ...
                  if (_typeof(descendant) !== 'object' || descendant == null) {
                    return;
                    ...
                    childData[descendant.props.column] = {
                      value: value,
                      props: (0, _filter_props_from.filterPropsFrom)(descendant.props),
                ...
                data.push({
                  data: childData,
                  props: (0, _filter_props_from.filterPropsFrom)(child.props),
                  __reactableMeta: true
                });
                break;
      ...
      value: function initialize(props) {
        ...
        var _this$parseChildData = this.parseChildData(props),
            data = _this$parseChildData.data,
            tfoot = _this$parseChildData.tfoot;
          ...
          for (var filterColumn in this._filterable) {
            if (typeof data[filterColumn] !== 'undefined') {
              ...
              if (typeof this._filterable[filterColumn] === 'undefined' || this._filterable[filterColumn] === 'default') {
                if ((0, _extract_data_from.extractDataFrom)(data, filterColumn).toString().toLowerCase().indexOf(filter) > -1) {
                  matchedChildren.push(children[i]);
                  break;
                }
              } else {
                // Apply custom filter
                if (this._filterable[filterColumn]((0, _extract_data_from.extractDataFrom)(data, filterColumn).toString(), filter)) {
                  matchedChildren.push(children[i]);
                  break;
                }
              }
      ...
      value: function sortByCurrentSort() {
        ...
        this.data.sort(function (a, b) {
          var keyA = (0, _extract_data_from.extractDataFrom)(a, currentSort.column);
          keyA = (0, _unsafe.isUnsafe)(keyA) ? keyA.toString() : keyA || '';
          var keyB = (0, _extract_data_from.extractDataFrom)(b, currentSort.column);
      ...
      value: function render() {
        ...
        var props = (0, _filter_props_from.filterPropsFrom)(this.props);
        var noDataText = this.props.noDataText ? _react.default.createElement("tr", {
        ...
        if (columns && columns.length > 0 && showHeaders) {
          tableHeader = _react.default.createElement(_thead.Thead, {
            columns: columns,
            filtering: filtering,
        ...
        return _react.default.createElement("table", props, tableHeader, _react.default.createElement("tbody", {
          className: "reactable-data",
          key: "tbody"
        }, currentChildren.length > 0 ? currentChildren : noDataText), pagination === true ? _react.default.createElement(_paginator.Paginator, {
          colSpan: columns.length,
...
})(this, function (_exports, _react, _table, _tr, _td, _th, _tfoot, _thead, _sort, _unsafe) {
  "use strict";
